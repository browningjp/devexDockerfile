...
RUN curl -L https://github.com/openshift/origin/releases/download/v1.5.1/openshift-origin-client-tools-v1.5.1-7b451fc-linux-64bit.tar.gz > oc.tar.gz && tar -xvf oc.tar.gz && mv oc /bin/oc
